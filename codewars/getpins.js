/* Kata instructions: He noted the PIN 1357, but he also said, it is possible that each of the digits he saw could actually be another adjacent digit (horizontally or vertically, but not diagonally). E.g. instead of the 1 it could also be the 2 or 4. And instead of the 5 it could also be the 2, 4, 6 or 8.
							...
							poss[obsArr[5]].forEach((el6) => {
								poss[obsArr[6]].forEach((el7) => {
									poss[obsArr[7]].forEach((el8) => {
										arrayOfPINs.push(el1 + el2 + el3 + el4 + el5 + el6 + el7 + el8);
									});
								});
							});
						});
